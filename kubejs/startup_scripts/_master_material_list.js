global.newMaterialParts = [
	...
	},
	{
		...
		itemParts: [
			...
			'hull_panel',
			'plating',
			'bolt' /*, 'wire', 'model_spool', 'model_wire_coil', */,
		],
		blockParts: ['storage_block'],
		ore: true,
		raw_ore: true,
	...
	*/
	...
	},
	{
		...
		tinkers_input: [
			...
			{ name: 'kubejs:molten_carbon', amount: 200 },
		],
	...
	*/
	...
	},
	{
		...
		tinkers_input: [
			{ name: 'tconstruct:molten_debris', amount: 90 },
			{ tag: 'forge:molten_steel', amount: 720 },
		],
		fluid: 'thick',
	...
	},
	{
		...
		tinkers_input: [
			{ tag: 'forge:molten_lead', amount: 180 },
			{ tag: 'forge:molten_tin', amount: 90 },
		],
		fluid: 'thick',
...

	{
		...
		amount: 1,
		dust_input: [
			'2x #forge:dusts/dielectric_alloy',
			'#forge:dusts/glowstone',
			'integrateddynamics:crystalized_menril_chunk',
		],
		ingot_input: [
			'2x #forge:ingots/dielectric_alloy',
			'#forge:dusts/glowstone',
			'integrateddynamics:crystalized_menril_chunk',
		],
		fluid: 'thick',
	...
	},
	{
		...
		tinkers_input: [
			{ tag: 'forge:molten_steel', amount: 90 },
			{ name: 'kubejs:molten_fluix', amount: 400 },
			{ name: 'kubejs:molten_carbon', amount: 400 },
			{ tag: 'tconstruct:molten_quartz', amount: 200 },
		],
	},
	{
		material: 'lumium',
	...
	*/
	...
	},
	{
		...
		amount: 3,
		dust_input: [
			'2x #forge:dusts/battery_alloy',
			'2x #forge:dusts/platinum',
			'#forge:dusts/cadmium',
		],
		ingot_input: [
			'2x #forge:ingots/battery_alloy',
			'2x #forge:ingots/platinum',
	...
	///////////////////////// Thermogenic //////////////////////////////////////
	{
		...
		trans_components: ['铜', '锌', '镍', '铀', '铂', '山铜', '精金', '振金', '龙矿'],
	...
	//////////////////////// Thermolytic /////////////////////////
	{
		...
		trans_components: ['铜', '奥金', '钴', '钛', '铂', '钨', '铱', '乌鲁', '龙矿'],
	...
	},
	{
		...
		trans_components: ['锡', '银', '铝', '镁', '锇', '紫金', '铱', '乌鲁', '龙矿'],
	...
	},
	{
		...
		trans_components: ['铁', '铅', '镍', '钛', '锇', '钨', '耐热金属', '乌鲁', '龙矿'],
	...
	},
	{
		...
		dust_input: [
			...
			'2x #forge:dusts/aluminum',
			'#forge:dusts/magnesium',
		],
		ingot_input: [
			'3x #forge:ingots/tier_1_mechanical_alloy',
			'2x #forge:ingots/aluminum',
			'#forge:ingots/magnesium',
		],
	},
	{
		...
		amount: 1,
		dust_input: [
			'3x #forge:dusts/tier_2_mechanical_alloy',
			'2x #forge:dusts/platinum',
			'#forge:dusts/ostrum',
			'create:precision_mechanism',
		],
		ingot_input: [
			'3x #forge:ingots/tier_2_mechanical_alloy',
			'2x #forge:ingots/platinum',
			'#forge:ingots/ostrum',
			'create:precision_mechanism',
		],
	},
	{
		...
		amount: 1,
		dust_input: [
			'3x #forge:dusts/tier_3_mechanical_alloy',
			'2x #forge:dusts/iridium',
			'#forge:dusts/vibranium',
			'create:precision_mechanism',
		],
		ingot_input: [
			'3x #forge:ingots/tier_3_mechanical_alloy',
			'2x #forge:ingots/iridium',
	...
	},
	{
		...
		dust_input: [
			...
			'2x #forge:dusts/amethyst_bronze',
			'#forge:dusts/uranium',
		],
		ingot_input: [
	...
	},
	{
		...
		amount: 1,
		dust_input: [
			'3x #forge:dusts/tier_2_electrical_alloy',
			'2x #forge:dusts/osmium',
			'#forge:dusts/promethium',
			'immersiveengineering:component_electronic',
		],
		ingot_input: [
			'3x #forge:ingots/tier_2_electrical_alloy',
			'2x #forge:ingots/osmium',
			'#forge:ingots/promethium',
			'immersiveengineering:component_electronic',
		],
	},
	{
		...
		amount: 1,
		dust_input: [
			'3x #forge:dusts/tier_3_electrical_alloy',
			'2x #forge:dusts/palladium',
			'#forge:dusts/uru',
			'kubejs:energy_orb_full',
		],
		ingot_input: [
			'3x #forge:ingots/tier_3_electrical_alloy',
			'2x #forge:ingots/palladium',
			'#forge:ingots/uru',
			'kubejs:energy_orb_full',
		],
	},
	...
	},
	{
		...
		amount: 2,
		dust_input: [
			'3x #forge:dusts/tier_1_magical_alloy',
			'2x #forge:dusts/infused_mithril',
			'#forge:dusts/manyullyn',
		],
		ingot_input: [
			'3x #forge:ingots/tier_1_magical_alloy',
			'2x #forge:ingots/infused_mithril',
	...
	},
	{
		...
		amount: 1,
		dust_input: [
			'3x #forge:dusts/tier_2_magical_alloy',
			'2x #forge:dusts/manasteel',
			'#forge:dusts/orichalcum',
		],
		ingot_input: [
			'3x #forge:ingots/tier_2_magical_alloy',
			'2x #forge:ingots/manasteel',
			'#forge:ingots/orichalcum',
		],
	},
	{
		...
		amount: 1,
		dust_input: [
			'3x #forge:dusts/tier_3_magical_alloy',
			'2x #forge:dusts/terrasteel',
			'#forge:dusts/draconium',
		],
		ingot_input: [
			'3x #forge:ingots/tier_3_magical_alloy',
			'2x #forge:ingots/terrasteel',
	...
	},
	{
		...
		amount: 1,
		dust_input: [
			'3x #forge:dusts/tier_3_structural_alloy',
			'2x #forge:dusts/adamantium',
			'#forge:dusts/vibraniumm',
			'mekanism:hdpe_sheet',
		],
		ingot_input: [
			'3x #forge:ingots/tier_3_structural_alloy',
			'2x #forge:ingots/adamantium',
			'#forge:ingots/vibraniumm',
			'mekanism:hdpe_sheet',
		],
	},
