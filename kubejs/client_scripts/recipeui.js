onEvent('mbd.recipe_ui.baka', event => {
    ...
    let background = new ImageWidget(
        ...
        178,
        84,
        new ResourceTexture('multiblocked:textures/gui/yuhuo.png')
    );
    ...
    itemIn.setContent('输入', input, false);
    ...
    let itemBound = new ImageWidget(
        149,
        22,
        20,
        40,
        new ResourceTexture('multiblocked:textures/gui/yuhuo_two.png')
    );
    ...
    for (let output of outputs) {
        ...
        itemOut.setContent('输出', output, false);
