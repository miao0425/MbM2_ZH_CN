onEvent('ponder.registry', event => {
    event
        .create(['naturesaura:wood_stand', 'naturesaura:gold_powder'])
        .scene(
            'ritual_of_the_forest',
            'Ritual of the Forest',
            'kubejs:ritual_of_the_forest',
            (scene, util) => {
                scene.showBasePlate();
                scene.idle(10);
                scene.text(
                    20,
                    'Place the Wooden Stands like so, they will hold items required for crafting',
                    [1.5, 1, 7.5]
                );
                let positions = [
                    { x: 1, y: 1, z: 7 },
                ...
                scene.text(
                    30,
                    'Place the Gold Powder around the center for each ritual.',
                    [3.5, 1, 5.5]
                );
                let goldPositions = [
                    { x: 3, y: 1, z: 5 },
